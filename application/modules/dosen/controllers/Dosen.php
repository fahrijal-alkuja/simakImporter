...
class Dosen extends CI_Controller
{
    ...
    public function anggota()
    {
        ...
        $semester = $this->input->post('semester');
        $prodi = $this->input->post('prodi');
        $this->API = "http://api.unikarta.ac.id/api/ajar/anggota?API-KEY=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6ImFsa3VqYSIsImlhdCI6MTU0MTk5MzkzNiwiZXhwIjoxNTQxOTk3NTM2fQ.eeVoobmrGio3Eu3vksKVgp_KGaHbVW2S7zhMsHeagVw&tahun=$tahun&semester=$semester&kode_program_studi=$prodi";
        $data['dosen'] = json_decode($this->curl->simple_get($this->API));
