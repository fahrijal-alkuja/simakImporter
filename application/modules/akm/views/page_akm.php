...
<div id = "cari"> 
		 <form action="<?php echo base_url('akm') ?>" method="POST">
...
<div id = "text_dumet"> 
   <form action="<?php echo base_url('akm/infort') ?>" method="POST">
                            <div class="row form-group">
                                <div class="col col-md-4">
                                    <div class="form-group">
                                        <label for="nf-email" class=" form-control-label">Tahun</label>	<br>
...
<br>
	...
	<table>
		...
		<tr>
		 ...
		 <?php if(is_array($akm)): ?>
		 <?php $no=1; foreach($akm as $n):?>
		
		<tr>
			<td><?=$no?></td>
			<td><?=$n->semester_pelaporan;?></td>
			<td><?=$n->nim;?></td>
			<td><?=$n->nama_mahasiswa;?></td>
			<td><?=round($n->ips,2)?></td>
			<td><?=round($n->ipk,2)?></td>
			<td><?=$n->sks_semester;?></td>
			<td><?=$n->sks_total;?></td>
			<td><?=$n->status_mahasiswa;?></td>
