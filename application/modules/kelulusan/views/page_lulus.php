...
<div id = "cari"> 
		 <form action="<?php echo base_url('kelulusan') ?>" method="POST">
                            <div class="row form-group">
                                <div class="col col-md-4">
                                    ...
                                    <div class="form-group">
										...
										<br>
                                        <select name="kode_program_studi" id="SelectLm" class="form-control-sm form-control">
                                            <option value="">Please select</option>
...
<div id = "text_dumet"> 
   <form action="<?php echo base_url('kelulusan/infort') ?>" method="POST">
                            <div class="row form-group">
                                <div class="col col-md-4">
                                    <div class="form-group">
                                        <label for="nf-email" class=" form-control-label">Tahun</label>	<br>
...
<br>
	...
	<table>
		<tr>
		 ...
		 <?php if(is_array($lulus)): ?>
		 <?php $no=1; foreach($lulus as $n):?>
		<tr>
			<td><?=$no?></td>
			<td><?=$n->nim;?></td>
			<td><?=$n->nama;?></td>
			<td><?=$n->id_jenis_keluar;?></td>
